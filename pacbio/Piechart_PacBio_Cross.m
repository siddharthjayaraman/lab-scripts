%% Pie charts
map = colormap(lines);
%VSGdata=importdata('Cross_vsg_pie_figure_data.txt');
VSGdata=importdata('CrossSETS_vsg_pie_figure_data.txt');
...
VSGdata.pie.label2={'';'';'';'';'';'';'';'';'';'';''};
VSGdata.pie.label3=strrep(VSGdata.textdata(2:end,1),'_','-');
...
pie(VSGdata.data(:,i),VSGdata.pie.explode,VSGdata.pie.label2);
   colormap(VSGdata.pie.colour);
box off
legend(VSGdata.pie.label3,'location','eastoutside','fontsize',14);
